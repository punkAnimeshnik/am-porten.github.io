...
class RepkaIterator implements Iterator<string> {
    private collection: RepkaCollection;
    ...
    constructor(collection: RepkaCollection, reverse: boolean = false) {
...
class RepkaCollection implements Aggregator {
...
const collection = new RepkaCollection();
